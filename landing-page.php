...
<div class="container col-xxl-8 px-4 py-5">
  ...
  <div class="container col-xxl-8 px-4 py-5">
    ...
    <h1 class="text-body-emphasis">Take Control of Your Tasks Today</h1>
    <p class="col-lg-8 mx-auto fs-5 text-muted">
    Streamline your life with our all-in-one task manager. Stay on top of your schedule, never miss a deadline, and track your productivity with ease. Start organizing smarter today!
    </p>
    <div class="d-inline-flex gap-2 mb-5">
      <button class="d-inline-flex align-items-center btn btn-info btn-lg px-4 rounded-pill" type="button">
        <a href="register-page.php" class="text-decoration-none text-white">Start Now</a>
      </button>
    </div>
  </div>
</div>
